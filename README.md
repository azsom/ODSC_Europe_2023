...
# Introduction to Interpretability in ML - ODSC Europe, 2023
...
You can recreate the python environment using the odsc_europe_2023.yml conda environment file by running these two commands in the terminal:

`conda env create -n odsc_europe_2023 -f odsc_europe_2023.yml`

`conda activate odsc_europe_2023`
